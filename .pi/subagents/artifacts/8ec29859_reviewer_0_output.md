...
- **Kinds/sources**: protocol `EventKind` set matches spec exactly (`minae-protocol/src/lib.rs`); ExternalChange stamped `EventSource::External` (`daemon.rs:276`).
